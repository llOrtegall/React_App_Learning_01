  ...
  return (
    <article className='bg-white cursor-pointer w-56 h-60 rounded-lg'>
      <figure className='relative mb-2 w-full h-4/5'>
        ...
        <img className='w-full h-full object-cover rounded-lg' src={item.images[0]} alt='example' />
        <div className='absolute top-0 right-0 flex justify-center items-center bg-white w-6 h-6 rounded-full pb-0.5 m-2'> + </div>
      </figure>
